    ...
    <div className="w-[500px] mt-48 p-12 mx-auto rounded-xl border">
      <div className="mt-5">
        <div className="text-center flex flex-col justify-center items-center">
          <ButtonWallet text="TronLink" icon="tronlink.png" href="https://tronlink.org" className="w-[200px]" />
          <li className="list-none my-4">
            <p className="text-xl mt-4">We use TronLink wallet for Tron Network</p>
            <p><Link href={'https://tronlink.org'} target="_blank">Download TronLink wallet</Link></p>
          </li>
          ...
          <p className="text-sm text-slate-400 mt-8">You will need to have TRX in a wallet that supports Tron Network, such as TronLink.  TronLink is a secure, non-custodial, end-to-end encrypted, blockchain wallet. You can learn more in their <a href="https://tronlink.org">website</a></p>
        </div>
      </div>
    </div>
  )
